...
const Footer = () => {
  return (
    <>
      <div className='bg-secondary-color flex flex-col md:flex-row py-4 px-4 md:px-6'>
        <div className='flex flex-wrap px-36 py-6 mb-4 md:mb-0 md:w-1/4'>
          <button className='bg-green-400 text-white w-36 rounded-full h-12 px-4 flex items-center'>
      ...
      <div className='bg-secondary-color py-3 flex flex-col md:flex-row items-center'>
